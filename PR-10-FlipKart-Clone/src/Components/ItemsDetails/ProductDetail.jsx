                ...
                <TableBody>
                    ...
                    <ColumnText>
                        ...
                        <TableCell>
                            ...
                            <Typography variant="body2">GST invoice available</Typography>
                            <Typography variant="body2">View more sellers starting from ₹329</Typography>
                        </TableCell>
                    </ColumnText>
                    <TableRow>
                        <TableCell colSpan={2}>
                    ...
                    <ColumnText>
                        ...
                        <TableCell>{product?.instructions || "No description available"}</TableCell>
                    </ColumnText>
                </TableBody>
            </Table>
        </>
